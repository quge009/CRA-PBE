...
public class BNESolverContext<Value, Bid> {
	...
	public UpdateRule<Bid> updateRule;
	public BRCalculator<Value, Bid> brc;
	public BRCalculator<Value, Bid> outerBRC;
	public Verifier<Value, Bid> verifier;
	public List<Utility<Value>> utilities;
	public Histories<Value> histories;
	public int nHistories;
	...
	public UpdateRule<Bid> getUpdateRule() {
		return updateRule;
	}
	public void setUpdateRule(UpdateRule<Bid> updateRule) {
	...
	public void setUtilities(List<Utility<Value>> utilities) {
		this.utilities=utilities;
	}
	public List<Utility<Value>> getUtilities(){
		return utilities;
	}
	...
	public Histories<Value> getHistories() {
		return histories;
	}
	public void setHistories(Histories<Value> histories) {
